...
var C__Projects_PLAYGROUND_sveltekit_demo_node_modules_querystring = createCommonjsModule(function(module, exports) {
...
Url.prototype.parse = function(url2, parseQueryString, slashesDenoteHost) {
  ...
  if (!slashesDenoteHost && url2.split("#").length === 1) {
    ...
    if (simplePath) {
      ...
      if (simplePath[2]) {
        ...
        if (parseQueryString) {
          this.query = C__Projects_PLAYGROUND_sveltekit_demo_node_modules_querystring.parse(this.search.substr(1));
        } else {
  ...
  if (qm !== -1) {
    ...
    if (parseQueryString) {
      this.query = C__Projects_PLAYGROUND_sveltekit_demo_node_modules_querystring.parse(this.query);
    }
...
Url.prototype.format = function() {
  ...
  if (this.query && util.isObject(this.query) && Object.keys(this.query).length) {
    query = C__Projects_PLAYGROUND_sveltekit_demo_node_modules_querystring.stringify(this.query);
  }
...
async function get_response({request, options, $session, route, status = 200, error}) {
  ...
  const body = options.amp ? rendered.html : `${rendered.html}
			...
			${serialized_data.map(({url: url2, payload}) => `<script type="svelte-data" url="${url2}">${s(payload)}</script>`).join("\n\n			")}
		`.replace(/^\t{2}/gm, "");
  const headers = {
...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-9ed2fca9.js", "src/routes/index.svelte": "pages\\index.svelte-4c710e56.js", "src/routes/about.svelte": "pages\\about.svelte-914b56a4.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      css: ["assets/start-a8cd1609.css", "assets/app-cfd1fb0d.css", "assets/pages\\index.svelte-9cf5ab6e.css"],
      js: ["start-9ed2fca9.js", "chunks/vendor-2c107171.js", "pages\\index.svelte-4c710e56.js"]
    },
    {
      type: "page",
      pattern: /^\/about\/?$/,
      ...
      css: ["assets/start-a8cd1609.css", "assets/app-cfd1fb0d.css"],
      js: ["start-9ed2fca9.js", "chunks/vendor-2c107171.js", "pages\\about.svelte-914b56a4.js"]
    }
  ]
};
...
var index_svelte = "div.svelte-s41arf.svelte-s41arf{color:black;width:400px;height:400px;background-color:deeppink;border-radius:5px}div.svelte-s41arf h1.svelte-s41arf{color:inherit}";
const css = {
  code: "div.svelte-s41arf.svelte-s41arf{color:black;width:400px;height:400px;background-color:deeppink;border-radius:5px}div.svelte-s41arf h1.svelte-s41arf{color:inherit}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script lang=\\"ts\\">import '../app.scss';\\r\\n</script>\\n\\n<main>\\n\\t<div>\\n\\t\\t<h1>A div here</h1>\\n\\t</div>\\n</main>\\n\\n<style lang=\\"scss\\">div {\\n  color: black;\\n  width: 400px;\\n  height: 400px;\\n  background-color: deeppink;\\n  border-radius: 5px;\\n}\\ndiv h1 {\\n  color: inherit;\\n}</style>\\n"],"names":[],"mappings":"AASmB,GAAG,4BAAC,CAAC,AACtB,KAAK,CAAE,KAAK,CACZ,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,gBAAgB,CAAE,QAAQ,CAC1B,aAAa,CAAE,GAAG,AACpB,CAAC,AACD,iBAAG,CAAC,EAAE,cAAC,CAAC,AACN,KAAK,CAAE,OAAO,AAChB,CAAC"}`
};
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main><div class="${"svelte-s41arf"}"><h1 class="${"svelte-s41arf"}">A div here</h1></div>
</main>`;
});
